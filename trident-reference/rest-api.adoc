...
[.lead]
While link:../trident-managing-k8s/tridentctl.html[tridentctl commands and options] are the easiest way to interact with the Astra Trident REST API, you can use the REST endpoint directly if you prefer.
